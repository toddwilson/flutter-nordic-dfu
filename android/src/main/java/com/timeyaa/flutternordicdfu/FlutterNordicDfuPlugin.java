...
public class FlutterNordicDfuPlugin implements MethodCallHandler {
  ...
  public void onMethodCall(MethodCall call, Result result) {
    if (call.method.equals("startDfu")) {
      ...
      startDfu(address, name, filePath, forceDfu, enableUnsafeExperimentalButtonlessServiceInSecureDfu,
          ...
          result, numberOfPackets, enablePRNs);
  ...
  private void startDfu(String address, @Nullable String name, String filePath, Boolean forceDfu,
      ...
      Boolean packetReceiptNotificationsEnabled, Boolean restoreBond, Boolean startAsForegroundService, Result result,
      Integer numberOfPackets, Boolean enablePRNs) {
  ...
  private void cancelNotification() {
    ...
    new Handler().postDelayed(new Runnable() {
      @Override
      public void run() {
        final NotificationManager manager = (NotificationManager) registrar.activity()
